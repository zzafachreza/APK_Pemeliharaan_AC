    ...
    return (
        ...
        <ImageBackground
            ...
            <View style={{ padding: 10 }}>
                <View style={{
                    padding: 10, backgroundColor: "white", borderWidth: 0.3,
                    borderRadius: 20
                }}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style={styles.page}>
                        ...
                        <View style={{ padding: 10, }}>
                            <Text style={{
                                fontFamily: fonts.primary[600], color: colors.primary, fontSize: 24,
                                textAlign: 'center'
                            }}>Daftar {route.params.level}</Text>
                            <MyGap jarak={15} />
                            ...
                            <View style={{ padding: 10 }}>
                                ...
                                <MyGap jarak={10} />
                                <TextInput onChangeText={x => setData({ ...data, nama_lengkap: x })} style={{
                                    borderWidth: 1, borderRadius: 10, paddingLeft: 10, paddingRight: 10, color: 'black',
                                    fontSize: 12, fontFamily: fonts.primary[400],
                                }} placeholder='Masukan Nama Lengkap' placeholderTextColor="gray" />
                            </View>
                            ...
                            <View style={{ padding: 10 }}>
                                ...
                                <MyGap jarak={10} />
                                <TextInput onChangeText={x => setData({ ...data, username: x })} style={{
                                    borderWidth: 1, borderRadius: 10, paddingLeft: 10, paddingRight: 10, color: 'black',
                                    fontSize: 12, fontFamily: fonts.primary[400],
                                }} placeholder='Masukan Username' placeholderTextColor="gray" />
                            </View>
                            ...
                            <View style={{ padding: 10 }}>
                                ...
                                <MyGap jarak={10} />
                                <TextInput onChangeText={x => setData({ ...data, email: x })} style={{
                                    borderWidth: 1, borderRadius: 10, paddingLeft: 10, paddingRight: 10, color: 'black',
                                    fontSize: 12, fontFamily: fonts.primary[400],
                                }} placeholder='Masukan Email' placeholderTextColor="gray" />
                            </View>
                            ...
                            <View style={{ padding: 10 }}>
                                ...
                                <MyGap jarak={10} />
                                <TextInput onChangeText={x => setData({ ...data, alamat: x })} style={{
                                    borderWidth: 1, borderRadius: 10, paddingLeft: 10, paddingRight: 10, color: 'black',
                                    fontSize: 12, fontFamily: fonts.primary[400],
                                }} placeholder='Masukan Alamat' placeholderTextColor="gray" />
                            </View>
                            ...
                            {/* TELEPON */}
                            <View style={{ padding: 10 }}>
                                <View><Text style={{ fontFamily: fonts.primary[400], fontSize: 15, color: colors.primary, }}>Telepon (Cth. 628123...): </Text></View>
                                <MyGap jarak={10} />
                                <TextInput keyboardType='phone-pad' onChangeText={x => setData({ ...data, telepon: x })} style={{
                                    borderWidth: 1, borderRadius: 10, paddingLeft: 10, paddingRight: 10, color: 'black',
                                    fontSize: 12, fontFamily: fonts.primary[400],
                                }} placeholder='Masukan Nomor Telepon' placeholderTextColor="gray" />
                            </View>
                            ...
                            <View style={{ padding: 10 }}>
                                ...
                                <MyGap jarak={10} />
                                <TextInput onChangeText={x => setData({ ...data, password: x })} style={{
                                    borderWidth: 1, borderRadius: 10, paddingLeft: 10, paddingRight: 10, color: 'black',
                                    fontSize: 12, fontFamily: fonts.primary[400],
                                }} placeholder='Masukan Password' placeholderTextColor="gray"
                            ...
                            <View style={{ padding: 10 }}>
                                ...
                                <MyGap jarak={10} />
                                <TextInput secureTextEntry onChangeText={x => setData({ ...data, repassword: x })} style={{
                                    borderWidth: 1, borderRadius: 10, paddingLeft: 10, paddingRight: 10, color: 'black',
                                    fontSize: 12, fontFamily: fonts.primary[400],
                                }} placeholder='Konfirmasi Password' placeholderTextColor="gray" />
                            </View>
                            ...
                            <TouchableNativeFeedback onPress={sendServer}>
                                <View style={{ padding: 10, backgroundColor: colors.primary, borderRadius: 10 }}>
                                    <Text style={{
                                        fontFamily: fonts.primary[600], fontSize: 24, textAlign: 'center',
                                        color: 'white',
                                    }}>Daftar</Text>
                                </View>
                            </TouchableNativeFeedback>
